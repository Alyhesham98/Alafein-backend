...
namespace Presistence.Migrations
{
    ...
    [Migration("20240326004943_posternullANDcontactperson")]
    partial class posternullANDcontactperson
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Alert.NotificationHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Core.Entities.Identity.UserDevice", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Core.Entities.Alert.NotificationHistory", b =>
                {
                    b.HasOne("Core.Entities.Alert.Notification", "Notification")
            ...
            modelBuilder.Entity("Core.Entities.Identity.UserDevice", b =>
                {
                    b.HasOne("Core.Entities.Identity.User", "User")
                        .WithOne("UserDevice")
                        .HasForeignKey("Core.Entities.Identity.UserDevice", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
