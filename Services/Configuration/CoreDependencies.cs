...
namespace Services.Configuration
{
    public static class CoreDependencies
    {
                                                              ...
                                                              IConfiguration configuration)
        {
            ...
            {
                configuration.RegisterServicesFromAssemblies(typeof(ServicesDependencies).Assembly);
            });
        ...
        public static IServiceCollection AddSerilogExtension(this IServiceCollection services,
